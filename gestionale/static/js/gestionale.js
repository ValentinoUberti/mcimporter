...
,
...

        {
...

           {
              ...
              creaFatturaXml : function ()

           {
               return this.__call__("crea_fattura_xml", makeArray(arguments));
           },

              creaFatturaXmlIstantanea : function ()

           {
               return this.__call__("crea_fattura_xml_istantanea", makeArray(arguments));
           },

              creaFatturaXmlAccredito : function ()

           {
               return this.__call__("crea_fattura_xml_accredito", makeArray(arguments));
           }
