...
class ORDINE_FORNITORE():
     ...
     def __init__(self,tipo_fattura,date,numero_interno_fattura):
         ...
         self.numero_fattura="Ordine Interno {0}".format(numero_interno_fattura)
             ...
             if row_index  < len(self.rows):
                 ...
                 try:
                     ...
                     for line_number in range(row_index,row_index + self.rows_per_page):
                         ...
                         self.pdf.cell(18, 0, self.rows[line_number][5],fill=f)
                         self.pdf.cell(14, 0, self.rows[line_number][6],fill=f)
                         self.pdf.cell(19, 0, self.rows[line_number][7],fill=f)
                         self.pdf.cell(0, 0, self.rows[line_number][8],fill=f)
	 ...
	 self.pdf.set_font('Times','', 12)
         ...
         self.pdf.set_font('', '')
         self.pdf.set_font_size(8)
         self.pdf.write(1, self.more_info)
         
         self.pdf.set_xy(120,273)
         self.pdf.set_font('', '')
         self.pdf.set_font_size(8)
         self.pdf.write(1, self.more_info_2)
         ...
         self.pdf.cell(50,4,"Codice fornitore : " + self.codice_cliente,0,2)
     ...
     def create_pdf(self):
         ...
         self.pdf.output('./applications/gestionale/static/ordine_fornitore.pdf','F')
...
if __name__ == '__main__':
    p = ORDINE_FORNITORE("ORDINE_FORNITORE","28/11/2017","1/2017")
    ...
    p.dettaglio("0000122","Banca sella","Iban","pagamento","scadenza")
