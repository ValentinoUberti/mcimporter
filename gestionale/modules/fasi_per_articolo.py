...
class FASI_PER_ARTICOLO():
                 ...
                 try:
                     for line_number in range(row_index,row_index + self.rows_per_page):
                         ...
                         if self.rows[line_number] is not None:
                             ...
                             starting_y =  self.pdf.get_y()
                             
                             
                             self.pdf.cell(8, 0, str(line_number+1),8,0,"",f)
                             
                             self.pdf.line(50, self.pdf.get_y()-6, 50, self.pdf.get_y() + 15)
                             self.pdf.line(90, self.pdf.get_y()-6, 90, self.pdf.get_y() + 15)
                             self.pdf.line(110, self.pdf.get_y()-6, 110, self.pdf.get_y() + 15)
                             self.pdf.line(128, self.pdf.get_y()-6, 128, self.pdf.get_y() + 15)
                             #self.pdf.line(176, self.pdf.get_y()-6, 176, self.pdf.get_y() + 15)
                             
                             
                             
                             self.pdf.set_y(starting_y-5)
                             self.pdf.multi_cell(40, 5, self.rows[line_number][0],0,"T")
                             self.pdf.set_y(starting_y)
                             self.pdf.set_x(52)
                             ...
                             self.pdf.set_y(starting_y-5)
                             self.pdf.set_x(52)
                             self.pdf.multi_cell(36, 5, self.rows[line_number][6],0,"T")
                             ...
                             self.pdf.set_x(92)
                             self.pdf.cell(19, 0, self.rows[line_number][3],fill=f)
                             
                             self.pdf.set_x(112)
                             self.pdf.cell(19, 0, self.rows[line_number][4],fill=f)
                             
                             
                             self.pdf.set_y(starting_y-5)
                             self.pdf.set_x(130)
                             self.pdf.multi_cell(36, 5, self.rows[line_number][2],0,"T")
                             #self.pdf.cell(20, 0, self.rows[line_number][2],fill=f)
                             ...
                             y = self.pdf.get_y() - 3
                             self.pdf.image(self.genera_bardcode(self.rows[line_number][7]), x=170, y=y, w=38)
                             #self.pdf.line(176, self.pdf.get_y()-6, 176, self.pdf.get_y() + 15)
                             
                             self.pdf.line(1, self.pdf.get_y()+15, 170, self.pdf.get_y() + 15)
                             
                             self.pdf.line(7, self.pdf.get_y()-6, 7, self.pdf.get_y() + 15)
     ...
     def add_header(self):
         ...
         self.pdf.image(self.genera_bardcode("PAUSA"), x=90, y=20, w=40,h=20)
...
if __name__ == '__main__':
    ...
    p = FASI_PER_ARTICOLO("Nome cliente","Codice_ordine_interno ciao","Rif ordine","data_consegna","Codice articolo","Descrizione articolo ---------------------------------asdassssasdasdasdasdasdasdasdasdasdasdasdasdasdas-","01","numero pezzi")
   
    for x in range(4):
        p.add_row("AAAAAhjjjjjjAAAAAhjjjjjjjjjjjjjjjjjAAAAAhjjjjjjjjjjjjjj"+str(x),"BBBBBB"+str(x),"Controllo"+str(x),"T.A."+str(x),"T.P."+str(x),"EE"+str(x),"NOTE"+str(x),"1164-1-1")
